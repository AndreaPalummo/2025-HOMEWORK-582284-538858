...
public class DiaDia {
	...
	/*Inizializza una nuova partita e l'interfaccia di I/O*/
	public DiaDia() {
		this.partita = new Partita();
		this.io = new IOConsole();
	}

	/*Avvia e gestisce il ciclo di gioco*/ 
	public void gioca() {
		String istruzione; 
	...
	/*Intrerpreta e processa i comandi inseriti*/
	...
	/*Posa gli attrezzi dalla borsa alla stanza corrente*/
	...
	/*Prende gli attrezzi dalla stanza corrente e li mette nella borsa*/
	...
	/*Gestisce lo spostamento da una stanza all'altra*/
	...
	/*Termina la partita chiudendo il gioco*/
	private void fine() {
		io.mostraMessaggio("Grazie di aver giocato!");
	}

	/*Punto di ingresso del codice, da qui parte una nuova istanza*/
